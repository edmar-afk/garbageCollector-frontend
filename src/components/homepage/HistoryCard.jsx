    ...
    <div className="relative border-l border-gray-700 -mb-2">
      <div className="flex overflow-hidden px-8">
        <div className="relative">
          <div className="absolute z-50 w-3 h-3 rounded-full mt-1.5 -left-1.5 border border-gray-900 bg-gray-700" />
          <div className="h-[100px] border-l-2 border-gray-300 -ml-[1px] mt-2" />
        </div>
        <div className="pl-4">
          <p className="mb-1 text-sm text-gray-400">Aug. 29 2025, 10:14pm</p>
